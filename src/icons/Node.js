const Icon = () => (
  <svg className='w-24 md:w-32' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 442.4 270.9'>
    <defs>
      <linearGradient
        id='b'
        x1='180.7'
        ...
        <stop offset='.3' stopColor='#3f8b3d' />
        <stop offset='.6' stopColor='#3e9637' />
        <stop offset='.9' stopColor='#3da92e' />
      ...
      <linearGradient
        ...
        <stop offset='.4' stopColor='#529f44' />
        <stop offset='.7' stopColor='#63b649' />
        <stop offset='.9' stopColor='#6abf4b' />
      </linearGradient>
      <linearGradient id='a' x1='114.6' y1='53.8' x2='212' y2='53.8' gradientUnits='userSpaceOnUse'>
        <stop offset='.1' stopColor='#6abf4b' />
        <stop offset='.3' stopColor='#63b649' />
        <stop offset='.6' stopColor='#529f44' />
        <stop offset='.9' stopColor='#3f873f' />
      </linearGradient>
      <linearGradient id='e' x1='114.9' y1='115.7' x2='212.3' y2='115.7' />
      <linearGradient id='f' x1='114.6' y1='143.4' x2='212' y2='143.4' />
      <linearGradient id='g' x1='114.9' y1='156' x2='212.3' y2='156' />
      <linearGradient id='h' x1='226.5' y1='78.4' x2='166.4' y2='201' />
